...
const CompaniesValidation = __importStar(require("./companies.validation"));
...
const create = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const newCompany = yield CompaniesService.create(company);
...
const read = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const company = res.locals.foundCompany;
        res.json(company);
    }
    catch (err) {
        (0, error_handlers_1.errorHandler)(err, res);
...
const update = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const updatedCompany = res.locals.validCompany;
        const id = parseInt(res.locals.foundCompany.company_id);
        const responseCompany = yield CompaniesService.update(updatedCompany, id);
...
const destroy = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const id = parseInt(res.locals.foundCompany.company_id);
        const response = yield CompaniesService.destroy(id);
        res.json(response);
    }
    catch (err) {
        (0, error_handlers_1.errorHandler)(err, res);
